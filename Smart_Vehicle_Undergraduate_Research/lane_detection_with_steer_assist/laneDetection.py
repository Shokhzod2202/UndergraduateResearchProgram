...
def addText(img, radius, direction, deviation, devDirection):
    ...
    cv2.putText(img, text , (30,70), font, 0.8, (0,0, 200), 2, cv2.LINE_AA)
    cv2.putText(img, text1, (30,120), font, 0.8, (0,0, 200), 2, cv2.LINE_AA)

    # Deviation
    deviation_text = 'Off Center: ' + str(round(abs(deviation), 3)) + 'm' + ' to the ' + devDirection
    cv2.putText(img, deviation_text, (30, 170), cv2.FONT_HERSHEY_TRIPLEX, 0.8, (0,0, 200), 2, cv2.LINE_AA)
